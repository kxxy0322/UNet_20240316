...
output_path = "C:/Data_Sentinel2/F/dataset_4/JPEGImages"
...
# 组合方式1: 翻转 + 对比度增强
operations_1 = [flip, enhance_contrast]
params_1 = [[], [0.8]]

# 组合方式2: 旋转90度 + 噪声扰动 + 对比度增强
operations_2 = [rotate, add_noise, enhance_contrast]
params_2 = [[90], [0.5], [1.2]]

# 组合方式3: 旋转180 + 翻转 + 缩放95 + 平移10 + 填充
operations_3 = [rotate, flip, resize, translate,fill_black]
params_3 = [[180], [], [0.95], [10, 10],[]]

# 组合方式4: 旋转210度 + 平移64 + 填充+噪声扰动
operations_4 = [rotate, translate,fill_black, add_noise]
params_4 = [[210], [-64, -64], [],[0.4]]

# 组合方式5: 翻转 + 旋转30度 + 填充 + 对比度增强
operations_5 = [flip, rotate, fill_black, enhance_contrast]
params_5 = [[], [30], [], [0.8]]

# 组合方式6：旋转270度 + 缩放90 + 填充 + 噪声0.4
operations_6 = [rotate, resize, fill_black,add_noise]
params_6 = [[270], [0.9],[], [0.4]]

# # 组合方式7：试验
# operations_7 = [rotate, translate, fill_black,enhance_contrast]
# params_7 = [[60], [0,32], [],[1.1]]
...
for filename in os.listdir(input_path):
    if filename.endswith(".jpg"):
        ...
        # 组合方式1
        output_filename = os.path.splitext(filename)[0] + "enhance_1.jpg"
        augment_image(img, operations_1, params_1, output_filename)

        # 组合方式2
        output_filename = os.path.splitext(filename)[0] + "enhance_2.jpg"
        augment_image(img, operations_2, params_2, output_filename)

        # 组合方式3
        output_filename = os.path.splitext(filename)[0] + "enhance_3.jpg"
        augment_image(img, operations_3, params_3, output_filename)

        # 组合方式4
        output_filename = os.path.splitext(filename)[0] + "enhance_4.jpg"
        augment_image(img, operations_4, params_4, output_filename)

        # 组合方式5
        output_filename = os.path.splitext(filename)[0] + "enhance_5.jpg"
        augment_image(img, operations_5, params_5, output_filename)

        # 组合方式6
        output_filename = os.path.splitext(filename)[0] + "enhance_6.jpg"
        augment_image(img, operations_6, params_6, output_filename)

        # # 组合方式7
        # output_filename = os.path.splitext(filename)[0] + "enhance_7.jpg"
