...
if __name__ == '__main__':
    ...
    jpgs_path = "C:/Data_Sentinel2/F/dataset_4/JPEGImages_before"
    # pngs_path = "datasets/SegmentationClass"
    pngs_path = "C:/Data_Sentinel2/F/dataset_4/SegmentationClass_before"
    # classes = ["_background_", "aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car", "cat", "chair", "cow",
    #            "diningtable", "dog", "horse", "motorbike", "person", "pottedplant", "sheep", "sofa", "train",
    #            "tvmonitor"]
    classes     = ["_background_","raft"]

    count = os.listdir("C:/Data_Sentinel2/F/dataset_4/before")
    for i in range(0, len(count)):
        path = os.path.join("C:/Data_Sentinel2/F/dataset_4/before", count[i])
